...
<nav class="fixed top-0 left-0 right-0 z-[9999] bg-slate-800/95 backdrop-blur-lg shadow-lg border-b border-ocean-500/20">
    <div class="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-20">
            ...
            <div class="flex items-center">
                <a href="<?php echo e(auth()->check() && auth()->user()->role === 'admin' ? route('admin.dashboard') : '/'); ?>" class="flex items-center gap-3 hover:opacity-80 transition-opacity">
            ...
            <div class="hidden md:flex items-center space-x-4 lg:space-x-6">
                ...
                <!-- Games with Dropdown -->
                <div class="relative group">
                    <a href="/games" class="flex items-center gap-1.5 text-white hover:text-ocean-300 transition-colors px-3 py-2 rounded-lg hover:bg-ocean-600/20 <?php echo e(request()->is('games*') || request()->is('leaderboards*') ? 'bg-ocean-600/30' : ''); ?>">
                        <span class="text-base">🎮</span>
                    ...
                    <div class="absolute top-full left-0 mt-2 w-56 bg-gradient-to-br from-deep-800/95 to-deep-900/95 backdrop-blur-lg border border-ocean-500/20 rounded-xl shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50">
                        <div class="p-2 space-y-1">
                            ...
                            <a href="<?php echo e(route('leaderboards')); ?>" class="dropdown-link flex items-center gap-3 px-3 py-2 text-gray-300 hover:text-white hover:bg-ocean-600/20 rounded-lg transition-colors w-full text-left">
                                <span class="text-lg">🏆</span>
    ...
    <div id="mobile-menu" class="md:hidden hidden bg-slate-800/95 backdrop-blur-lg border-t border-ocean-500/20 max-h-[calc(100vh-5rem)] overflow-y-auto">
        <div class="px-2 pt-2 pb-3 space-y-1">
            ...
            <!-- Games Section -->
            <div class="space-y-1">
                <a href="/games" class="mobile-nav-link flex items-center gap-3 hover:text-ocean-400 hover:bg-ocean-600/20 px-3 py-2 rounded-lg transition-colors w-full text-left <?php echo e(request()->is('games*') && !request()->is('leaderboards*') ? '!bg-ocean-600/30 !text-ocean-300' : 'text-white'); ?>" style="<?php echo e(request()->is('games*') && !request()->is('leaderboards*') ? 'background-color: rgba(20, 184, 166, 0.3) !important; color: #5eead4 !important;' : ''); ?>">
                    <span class="text-lg">🎮</span>
                    <span class="text-sm font-medium">Games</span>
                </a>
                
                <div class="ml-8 space-y-1">
                    <a href="<?php echo e(route('leaderboards')); ?>" class="mobile-nav-link flex items-center gap-3 text-gray-300 hover:text-white hover:bg-ocean-600/20 px-3 py-2 rounded-lg transition-colors w-full text-left <?php echo e(request()->is('leaderboards*') ? '!bg-ocean-600/30 !text-ocean-300' : ''); ?>" style="<?php echo e(request()->is('leaderboards*') ? 'background-color: rgba(20, 184, 166, 0.3) !important; color: #5eead4 !important;' : ''); ?>">
                        <span class="text-lg">🏆</span>
                        <span class="text-sm font-medium">Leaderboards</span>
                    </a>
                </div>
...
<?php echo $__env->make('auth.modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Rayver\Desktop\my_app\resources\views/navigation.blade.php ENDPATH**/ ?>