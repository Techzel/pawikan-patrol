...
<div id="patrolReportsIndex" class="min-h-screen bg-gray-900">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10 pb-12 border-t border-white/5 mt-10">
        <div class="mb-8 flex items-center justify-between">
            <div class="flex items-center gap-3">
                <h2 class="text-2xl font-bold text-white cinzel-heading">Report Analytics Summary</h2>
                <button onclick="toggleAnalytics()" class="text-xs bg-white/5 hover:bg-white/10 text-ocean-400 px-3 py-1 rounded-full border border-white/10 transition-all">
                    <span id="toggleText">Hide Stats</span>
                </button>
            </div>
            <div class="flex items-center gap-2 text-xs text-gray-400 cinzel-text bg-white/5 px-3 py-2 rounded-full border border-white/10">
                <i class="fas fa-calendar-alt text-ocean-400"></i>
                <span>Data as of <?php echo e(now()->format('M d, Y')); ?></span>
            </div>
        </div>
        ...
        <div id="analyticsContent" class="transition-all duration-500 overflow-hidden">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                <div class="glass-dark border border-white/10 rounded-2xl p-5 hover:border-ocean-500/50 transition-all group">
                    ...
                    <div class="text-3xl font-bold text-white leading-tight"><?php echo e($analytics['total']); ?></div>
                ...
                <div class="glass-dark border border-white/10 rounded-2xl p-5 hover:border-yellow-500/50 transition-all group">
                    <div class="flex items-center justify-between mb-3">
                        ...
                        <?php $pendingTrend = $analytics['pending'] > 0 ? 'Action Needed' : 'All Clear'; ?>
                        <span class="text-xs font-bold text-yellow-400 bg-yellow-500/10 px-2 py-1 rounded-md"><?php echo e($pendingTrend); ?></span>
                    </div>
                    <div class="text-3xl font-bold text-white leading-tight"><?php echo e($analytics['pending']); ?></div>
                ...
                <div class="glass-dark border border-white/10 rounded-2xl p-5 hover:border-emerald-500/50 transition-all group">
                    <div class="flex items-center justify-between mb-3">
                        ...
                        ?>
                        <span class="text-xs font-bold text-emerald-400 bg-emerald-500/10 px-2 py-1 rounded-md"><?php echo e($acceptanceRate); ?>% Rate</span>
                    </div>
                    <div class="text-3xl font-bold text-white leading-tight"><?php echo e($analytics['accepted']); ?></div>
                        ...
                        <?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div>
                                <div class="flex justify-between text-xs mb-1.5">
                                    <span class="text-gray-300"><?php echo e($type['label']); ?></span>
                                    <span class="text-white font-bold"><?php echo e($count); ?></span>
                                </div>
                                <div class="w-full bg-white/10 rounded-full h-2 overflow-hidden">
                                    <div class="<?php echo e($type['color']); ?> h-full transition-all duration-1000" style="width: <?php echo e($percentage); ?>%"></div>
                                </div>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                    ...
                    <div class="p-6">
                        <div class="flex items-center gap-4 h-full">
                            <div class="flex-1 space-y-5">
                                <?php $__currentLoopData = ['critical' => 'red', 'high' => 'orange', 'medium' => 'yellow', 'low' => 'green']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $priority => $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="flex items-center gap-3">
                                        <div class="w-2 h-2 rounded-full bg-<?php echo e($color); ?>-500"></div>
                                        <div class="flex-1">
                                            <div class="flex justify-between text-xs mb-1">
                                                <span class="text-gray-400 capitalize"><?php echo e($priority); ?></span>
                                                <span class="text-white font-bold"><?php echo e($analytics['by_priority'][$priority] ?? 0); ?></span>
                                            </div>
                                            <?php 
                                            ...
                                            <div class="w-full bg-white/5 rounded-full h-1">
                                                <div class="bg-<?php echo e($color); ?>-500 h-full rounded-full" style="width: <?php echo e($pPercent); ?>%"></div>
                                            </div>
                                        </div>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="hidden sm:flex flex-col items-center justify-center border-l border-white/10 pl-8 ml-4">
                                <div class="text-4xl font-black text-red-500/80"><?php echo e($analytics['by_priority']['critical'] ?? 0); ?></div>
