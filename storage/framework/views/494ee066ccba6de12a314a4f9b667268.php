                ...
                <div class="glass-dark rounded-2xl p-8 border border-ocean-500/20 bg-gradient-to-r from-ocean-600/20 to-ocean-800/20">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-xl text-gray-300 cinzel-text">Welcome back, <span class="text-ocean-300 font-semibold"><?php echo e($patroller->name); ?></span>!</p>
                            <p class="text-gray-400 mt-2 cinzel-text"><?php echo e(now()->format('l, F j, Y')); ?> • <?php echo e(now()->format('g:i A')); ?></p>
                        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                ...
                <div class="stat-card glass-dark rounded-2xl p-6 border border-ocean-500/20 bg-gradient-to-br from-blue-500/10 to-blue-600/10 hover:from-blue-500/20 hover:to-blue-600/20 transition-all duration-300">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <div class="text-right">
                            <p class="text-3xl font-bold text-white cinzel-heading"><?php echo e($totalReports); ?></p>
                ...
                <div class="stat-card glass-dark rounded-2xl p-6 border border-ocean-500/20 bg-gradient-to-br from-yellow-500/10 to-yellow-600/10 hover:from-yellow-500/20 hover:to-yellow-600/20 transition-all duration-300">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <div class="text-right">
                            <p class="text-3xl font-bold text-white cinzel-heading"><?php echo e($pendingReports); ?></p>
                ...
                <div class="stat-card glass-dark rounded-2xl p-6 border border-ocean-500/20 bg-gradient-to-br from-green-500/10 to-green-600/10 hover:from-green-500/20 hover:to-green-600/20 transition-all duration-300">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <div class="text-right">
                            <p class="text-3xl font-bold text-white cinzel-heading"><?php echo e($resolvedReports); ?></p>
                ...
                <div class="stat-card glass-dark rounded-2xl p-6 border border-ocean-500/20 bg-gradient-to-br from-red-500/10 to-red-600/10 hover:from-red-500/20 hover:to-red-600/20 transition-all duration-300">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <div class="text-right">
                            <p class="text-3xl font-bold text-white cinzel-heading"><?php echo e($criticalReports); ?></p>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-6 mb-8">
                ...
                <div class="lg:col-span-1 space-y-4">
                    <div class="glass-dark rounded-2xl p-6 border border-ocean-500/20">
                        ...
                        <div class="space-y-4">
                            <a href="<?php echo e(route('patroller.reports.create')); ?>" class="group block w-full bg-gradient-to-r from-ocean-500 to-ocean-600 hover:from-ocean-600 hover:to-ocean-700 text-white font-semibold py-4 px-6 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl text-center cinzel-text">
                                <i class="fas fa-file-plus mr-3 text-lg group-hover:animate-pulse"></i>
                                <span>Submit New Report</span>
                            </a>
                            <a href="<?php echo e(route('patroller.reports.index')); ?>" class="group block w-full bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-semibold py-4 px-6 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl text-center cinzel-text">
                                <i class="fas fa-list mr-3 text-lg group-hover:animate-pulse"></i>
                                <span>View All Reports</span>
                            </a>
                            <a href="<?php echo e(route('patroller.profile')); ?>" class="group block w-full bg-gradient-to-r from-purple-500 to-purple-600 hover:from-purple-600 hover:to-purple-700 text-white font-semibold py-4 px-6 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl text-center cinzel-text">
                ...
                <div class="lg:col-span-3">
                    <div class="glass-dark rounded-2xl p-6 border border-ocean-500/20 h-full">
                        <div class="flex items-center justify-between mb-6">
                            ...
                            <a href="<?php echo e(route('patroller.reports.index')); ?>" class="text-ocean-400 hover:text-ocean-300 text-sm cinzel-text transition-colors">
                                ...
                                <div class="group flex items-center justify-between p-4 bg-white/5 hover:bg-white/10 rounded-xl transition-all duration-300 border border-transparent hover:border-ocean-500/30">
                                    <div class="flex items-center space-x-4 flex-1">
                                        <div class="w-12 h-12 rounded-xl flex items-center justify-center
                                            ...
                                            <?php else: ?> bg-gradient-to-br from-green-400 to-green-600 <?php endif; ?> shadow-lg">
                                            <i class="fas fa-file-alt text-white"></i>
                                        </div>
                                        <div class="flex-1 min-w-0">
                                            <h4 class="text-white font-semibold cinzel-text truncate group-hover:text-ocean-300 transition-colors"><?php echo e($report->title); ?></h4>
                                            <p class="text-gray-400 text-sm cinzel-text"><?php echo e($report->location); ?></p>
                                            <p class="text-gray-500 text-xs cinzel-text"><?php echo e($report->created_at->diffForHumans()); ?></p>
                                        </div>
                                    </div>
...
<?php echo $__env->make('layouts.patroller', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Rayver\Desktop\pawikan-patrol\my_app\resources\views/patroller/dashboard.blade.php ENDPATH**/ ?>