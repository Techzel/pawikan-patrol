...
<body class="bg-black min-h-screen text-white overflow-hidden selection:bg-ocean-500 selection:text-white">
    ...
    <div class="fixed top-28 left-4 z-50 mb-4">
        <a href="<?php echo e(route('games.index')); ?>" class="bg-deep-800/80 p-2 rounded-full border border-ocean-500/30 text-ocean-300 hover:bg-ocean-900/80 transition-all shadow-md backdrop-blur-sm flex items-center justify-center group" title="Back to Games">
    ...
    <div class="fixed inset-0 z-10 w-full h-full">
        ...
        <div id="gameOverScreen" class="absolute inset-0 flex items-center justify-center bg-black/80 backdrop-blur-sm z-50 hidden transition-opacity duration-300">
            <div class="bg-gray-900 border border-white/10 p-6 rounded-2xl max-w-sm w-[90%] text-center relative overflow-hidden">
                ...
                <div class="flex flex-col gap-3">
                    ...
                    <a href="<?php echo e(route('games.index')); ?>" class="w-full py-3 bg-transparent border border-white/10 text-gray-400 hover:bg-white/5 hover:text-white rounded-xl font-bold font-poppins transition-all text-sm">
                        Exit
                    </a>
                </div>
        ...
        <div id="guest-modal" class="absolute inset-0 z-[100] flex items-center justify-center bg-black/90 backdrop-blur-md transition-all duration-700 ease-out hidden pointer-events-auto cursor-default"> <!-- Start with background effect -->
            <div id="guest-modal-content" class="bg-deep-900 border border-red-500/30 p-8 rounded-2xl max-w-md w-full text-center shadow-2xl relative transform scale-75 opacity-0 transition-all duration-700 ease-out">
                ...
                <h2 class="text-2xl font-bold text-white mb-2 font-cinzel tracking-wider">GUEST MODE</h2>
...
<?php /**PATH C:\Users\Rayver\Desktop\my_app\resources\views/games/find-the-pawikan.blade.php ENDPATH**/ ?>