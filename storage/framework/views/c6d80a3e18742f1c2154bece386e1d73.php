...
?>
                            ...
                            <!-- Hidden File Input -->
                            <form id="profilePictureForm" method="POST" action="<?php echo e(route('profile.update')); ?>" enctype="multipart/form-data" class="hidden">
                                <?php echo csrf_field(); ?>
                ...
                <div class="glass-dark rounded-2xl p-6 border border-ocean-500/30">
                    ...
                    <div id="profileDisplay" class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <div class="bg-deep-800/50 rounded-lg px-3 py-2 text-white text-sm border border-deep-700">
                                <?php echo e(auth()->user()->username ?? 'Not set'); ?>
                        ...
                        <div>
                            ...
                            <div class="bg-deep-800/50 rounded-lg px-3 py-2 text-white text-sm border border-deep-700">
                                <?php echo e(auth()->user()->created_at->format('M j, Y')); ?>
                    ...
                    <!-- Profile Edit Mode -->
                    <form id="profileEditForm" method="POST" action="<?php echo e(route('profile.update')); ?>" style="display: none;">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('PUT'); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Rayver\Desktop\pawikan-patrol\my_app\resources\views/profile.blade.php ENDPATH**/ ?>