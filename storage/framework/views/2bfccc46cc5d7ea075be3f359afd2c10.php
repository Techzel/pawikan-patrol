                ...
                <div class="glass-dark rounded-2xl p-8 border border-green-500/20 bg-gradient-to-r from-green-600/20 to-green-800/20">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-xl text-gray-300">Welcome back, <span class="text-green-400 font-semibold"><?php echo e($patroller->name); ?></span>!</p>
                        ...
                        <div class="hidden md:block">
                            <?php if($patroller->profile_picture): ?>
                                <img src="<?php echo e(Str::startsWith($patroller->profile_picture, 'data:') ? $patroller->profile_picture : asset('storage/' . $patroller->profile_picture)); ?>" class="w-24 h-24 rounded-full object-cover shadow-lg border-2 border-green-400">
                            <?php else: ?>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-6 mb-8">
                ...
                <div class="lg:col-span-1 space-y-4">
                    <div class="glass-dark rounded-2xl p-6 border border-green-500/20">
                        ...
                        <div class="space-y-4">
                            <a href="<?php echo e(route('patroller.reports.create')); ?>" class="group block w-full bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white font-semibold py-4 px-6 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl text-center">
                ...
                <div class="lg:col-span-3">
                    <div class="glass-dark rounded-2xl p-6 border border-green-500/20 h-full">
                        <div class="flex items-center justify-between mb-6">
                            ...
                            <a href="<?php echo e(route('patroller.reports.index')); ?>" class="text-green-400 hover:text-green-300 text-sm transition-colors">
                        ...
                        <div class="space-y-3 max-h-80 overflow-y-auto custom-scrollbar">
                                ...
                                <div class="group flex items-center justify-between p-4 bg-white/5 hover:bg-white/10 rounded-xl transition-all duration-300 border border-transparent hover:border-green-/30">
                                    <div class="flex items-center space-x-4 flex-1">
                                        ...
                                        <div class="flex-1 min-w-0">
                                            <h4 class="text-white font-semibold truncate group-hover:text-green- transition-colors"><?php echo e($report->title); ?></h4>
                                    ...
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <a href="<?php echo e(route('patroller.reports.show', $report)); ?>" class="w-8 h-8 bg-green-500/20 hover:bg-green-500/40 text-green-400 hover:text-green-300 rounded-lg flex items-center justify-center transition-all duration-300 transform hover:scale-110">
                            ...
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <div class="text-center py-12">
                                    ...
                                    <a href="<?php echo e(route('patroller.reports.create')); ?>" class="bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white px-6 py-3 rounded-lg font-medium transition-all duration-300 transform hover:scale-105 shadow-lg">
