<?php $__env->startSection('title', 'Patrol Reports Dashboard'); ?>
            ...
            <div class="relative z-10 p-6 sm:p-8">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
                    ...
                    <div class="flex flex-wrap justify-center gap-4 header-stats">
                        ...
                        <div class="text-center">
                            <div class="text-2xl font-bold text-indigo-400"><?php echo e($totalReports); ?></div>
                            <div class="text-xs text-gray-400 cinzel-text">Total Reports</div>
                        </div>
                        <div class="text-center">
                            <div class="text-2xl font-bold text-yellow-400"><?php echo e($pendingReports); ?></div>
                            <div class="text-xs text-gray-400 cinzel-text">Pending</div>
                        </div>
                        <div class="text-center">
                            <div class="text-2xl font-bold text-green-400"><?php echo e($approvedReports); ?></div>
                ...
                <div class="mt-6 pt-4 border-t border-white/10 flex flex-wrap items-center justify-center gap-4 text-xs text-gray-300 status-info">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <span>Reports: <span class="font-medium text-white"><?php echo e($pendingReports); ?> Pending</span></span>
                    </div>
                    <div class="hidden sm:block w-px h-4 bg-white/20"></div>
                    <div class="flex items-center gap-2">
            ...
            <div class="glass-card p-6 stat-card hover:shadow-lg transform transition-all duration-300 hover:border-indigo-400/50 border border-white/10 rounded-xl backdrop-blur-lg bg-gradient-to-br from-indigo-900/30 to-purple-900/30">
                <div class="flex items-center justify-between">
                    <div class="fade-in">
                        ...
                        <h3 class="text-4xl font-bold text-white mb-1"><?php echo e($totalReports); ?></h3>
                ...
                <div class="mt-4">
                    <div class="flex items-center justify-between text-xs text-gray-400 mb-1">
                        ...
                        <span class="flex items-center">
                            ...
                            <span><?php echo e($totalReports); ?></span>
                        </span>
                    </div>
            ...
            <div class="glass-card p-6 stat-card hover:shadow-lg transform transition-all duration-300 hover:border-yellow-400/50 border border-white/10 rounded-xl backdrop-blur-lg bg-gradient-to-br from-amber-900/30 to-yellow-900/30">
                <div class="flex items-center justify-between">
                    <div class="fade-in">
                        ...
                        <h3 class="text-4xl font-bold text-yellow-400 mb-1"><?php echo e($pendingReports); ?></h3>
                ...
                <div class="mt-4">
                    <div class="flex items-center justify-between text-xs text-gray-400 mb-1">
                        ...
                        <span class="flex items-center">
                            ...
                            <span><?php echo e($pendingReports); ?></span>
                        </span>
                    </div>
                    <div class="progress-container">
            ...
            <div class="glass-card p-6 stat-card hover:shadow-lg transform transition-all duration-300 hover:border-green-400/50 border border-white/10 rounded-xl backdrop-blur-lg bg-gradient-to-br from-emerald-900/30 to-green-900/30">
                <div class="flex items-center justify-between">
                    <div class="fade-in">
                        ...
                        <h3 class="text-4xl font-bold text-green-400 mb-1"><?php echo e($approvedReports); ?></h3>
                        <p class="text-xs text-gray-400"><?php echo e($approvedPercentage); ?>% of total</p>
                    </div>
                ...
                <div class="mt-4">
                    <div class="flex items-center justify-between text-xs text-gray-400 mb-1">
                        ...
                        <span><?php echo e($approvedReports); ?></span>
                    </div>
                    <div class="progress-container">
                        <div class="progress-bar bg-gradient-to-r from-green-500 to-emerald-500" style="width: <?php echo e($approvedPercentage); ?>%"></div>
                    </div>
                </div>
            </div>
            ...
            <div class="glass-card p-6 stat-card hover:shadow-lg transform transition-all duration-300 hover:border-red-400/50 border border-white/10 rounded-xl backdrop-blur-lg bg-gradient-to-br from-rose-900/30 to-red-900/30">
                <div class="flex items-center justify-between">
                    <div class="fade-in">
                        ...
                        <h3 class="text-4xl font-bold text-red-400 mb-1"><?php echo e($rejectedReports); ?></h3>
                ...
                <div class="mt-4">
                    <div class="flex items-center justify-between text-xs text-gray-400 mb-1">
                        <span>This month</span>
                        <span><?php echo e($rejectedReports); ?></span>
                    </div>
                    <div class="progress-container">
        ...
        <div class="glass-card rounded-2xl shadow-xl overflow-hidden mt-8">
            <div class="p-6 border-b border-white/10 flex items-center justify-between bg-gradient-to-r from-indigo-900/30 to-purple-900/30">
                ...
                <div class="flex gap-2">
                    <a href="<?php echo e(route('admin.patrol-reports.index')); ?>" class="px-4 py-2 bg-indigo-500/20 hover:bg-indigo-500/30 text-indigo-400 border border-indigo-500/30 rounded-lg transition-colors text-sm font-medium">
                        View All Reports
                    </a>
                </div>
            </div>
                            ...
                            <tr class="hover:bg-white/5 transition-all duration-200 border-b border-white/5 last:border-0">
                                <td class="px-6 py-4 text-white/90">
                                    <div class="flex items-center gap-3">
                                        <img src="https://ui-avatars.com/api/?name=<?php echo e(urlencode($report->patroller->name)); ?>&background=6366f1&color=fff"
                                             alt="<?php echo e($report->patroller->name); ?>"
                                             class="w-10 h-10 rounded-full border-2 border-indigo-500/30">
                                        <div>
                                            <span class="text-white font-medium"><?php echo e($report->patroller->name); ?></span>
                                            <div class="text-xs text-gray-400"><?php echo e($report->patroller->patroller_id ?? 'N/A'); ?></div>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4 text-gray-300">
                                    <div>
                                        <div class="font-medium text-white"><?php echo e($report->title); ?></div>
                                        <div class="text-sm text-gray-400"><?php echo e(Str::limit($report->description, 40)); ?></div>
                                    </div>
                                </td>
                                <td class="px-6 py-4 text-white/90">
                                    <?php if($report->status == 'pending_review'): ?>
                                ...
                                <td class="px-6 py-4 text-white/90">
                                    <?php if($report->priority == 'critical'): ?>
                                        <span class="status-badge bg-red-500/20 text-red-400 border border-red-500/30">
                                    ...
                                    <?php elseif($report->priority == 'medium'): ?>
                                        <span class="status-badge bg-yellow-500/20 text-yellow-400 border border-yellow-500/30">
                                ...
                                <td class="px-6 py-4 text-gray-300">
                                    <div class="flex flex-col">
                                        <span><?php echo e($report->created_at->format('M d, Y')); ?></span>
                                        <span class="text-xs text-gray-500"><?php echo e($report->created_at->format('H:i')); ?></span>
                                    </div>
                                </td>
                                <td class="px-6 py-4">
                                    <div class="flex items-center justify-center gap-2 action-buttons">
                                        <a href="<?php echo e(route('admin.patrol-reports.show', $report)); ?>"
                                        ...
                                        <?php if($report->status == 'pending_review'): ?>
                                            <button onclick="quickAction(<?php echo e($report->id); ?>, 'under_review')"
                                        ...
                                        <?php elseif($report->status == 'under_review'): ?>
                                            <button onclick="quickAction(<?php echo e($report->id); ?>, 'approved')"
                                            ...
                                            <button onclick="quickAction(<?php echo e($report->id); ?>, 'rejected')"
                                                    class="action-btn bg-red-500/20 hover:bg-red-500/30 text-red-400 border-red-500/30 hover:border-red-400/60"
                                                    title="Reject Report">
                                                <i class="fas fa-times text-sm"></i>
                                            </button>
                                            <button onclick="quickAction(<?php echo e($report->id); ?>, 'resolved')"
                                            ...
                                            <button onclick="quickAction(<?php echo e($report->id); ?>, 'closed')"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Rayver\Desktop\pawikan-patrol\my_app\resources\views/admin/patrol-reports/dashboard.blade.php ENDPATH**/ ?>