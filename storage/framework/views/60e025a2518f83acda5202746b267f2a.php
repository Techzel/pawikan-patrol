<?php $__env->startSection('title', 'Leaderboards - Pawikan Patrol'); ?>
...
<div class="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 py-8 relative overflow-hidden">
    ...
    <div class="container mx-auto px-4 max-w-6xl relative z-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="bg-white/10 backdrop-blur-md rounded-2xl shadow-2xl p-6 text-center transform hover:scale-105 transition-all duration-200 border border-white/20 relative overflow-hidden group">
                    ...
                    <div class="relative z-10">
                        ...
                        <div class="text-4xl font-bold bg-gradient-to-r from-yellow-400 to-orange-500 bg-clip-text text-transparent mb-1">
                            #<?php echo e($overallRank); ?>

                        </div>
                        <div class="text-sm text-gray-300 mb-3"><?php echo e(number_format($overallScore)); ?> points</div>
                    </div>
                </div>
                ...
                <div class="bg-white/10 backdrop-blur-md rounded-2xl shadow-2xl p-6 text-center transform hover:scale-105 transition-all duration-200 border border-white/20 relative overflow-hidden group">
                    ...
                    <div class="relative z-10">
                        ...
                        <div class="text-sm text-gray-300 mb-3"><?php echo e(number_format($quizScore)); ?> points</div>
                    </div>
                </div>
                ...
                <div class="bg-white/10 backdrop-blur-md rounded-2xl shadow-2xl p-6 text-center transform hover:scale-105 transition-all duration-200 border border-white/20 relative overflow-hidden group">
                    ...
                    <div class="relative z-10">
                        ...
                        <div class="text-4xl font-bold bg-gradient-to-r from-green-400 to-emerald-500 bg-clip-text text-transparent mb-1">
                            #<?php echo e($wordScrambleRank); ?>

                        </div>
                        <div class="text-sm text-gray-300 mb-3"><?php echo e(number_format($wordScrambleScore)); ?> points</div>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="overflow-x-auto rounded-lg border border-white/10 shadow-xl backdrop-blur-sm">
                            <table class="w-full">
                                ...
                                <tbody id="overallLeaderboardBody" class="bg-white/5 backdrop-blur-sm">
                                    <?php if($overallLeaderboard->count() > 0): ?>
                                        <?php
                                            $currentScore = null;
                                            $currentRank = 0;
                                        ?>
                                        <?php $__currentLoopData = $overallLeaderboard; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $player): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php
                                            ...
                                            ?>
                                            <tr class="hover:bg-white/10 transition-all duration-150 <?php if(auth()->id() == $player->user_id): ?> bg-blue-500/20 border-l-4 border-blue-400 <?php endif; ?> border-b border-white/5 player-row" data-player-id="<?php echo e($player->user_id); ?>" data-player-name="<?php echo e($player->name); ?>" data-player-score="<?php echo e($player->total_score); ?>" data-player-games="<?php echo e($player->games_played); ?>" data-player-accuracy="<?php echo e(number_format($player->avg_accuracy, 1)); ?>">
                                                <td class="py-4 px-6">
                                                    <?php if($currentRank <= 3): ?>
                                                        <!-- Enhanced Rank Badge -->
                                                        <div class="relative inline-flex items-center justify-center group">
                                                            <!-- Outer glow ring -->
                                                            <div class="absolute inset-0 rounded-full animate-pulse <?php if($currentRank == 1): ?> bg-yellow-400/30 <?php elseif($currentRank == 2): ?> bg-gray-400/30 <?php else: ?> bg-orange-400/30 <?php endif; ?> opacity-50 blur-md"></div>
                                                            
                                                            <!-- Main badge container -->
                                                            <div class="relative inline-flex flex-col items-center">
                                                                <!-- Badge background with gradient and border -->
                                                                <div class="w-14 h-14 rounded-full <?php if($currentRank == 1): ?> bg-gradient-to-br from-yellow-400/80 via-yellow-500/80 to-yellow-600/80 <?php elseif($currentRank == 2): ?> bg-gradient-to-br from-gray-400/80 via-gray-500/80 to-gray-600/80 <?php else: ?> bg-gradient-to-br from-orange-400/80 via-orange-500/80 to-orange-600/80 <?php endif; ?> shadow-lg border-2 <?php if($currentRank == 1): ?> border-yellow-400/50 <?php elseif($currentRank == 2): ?> border-gray-400/50 <?php else: ?> border-orange-400/50 <?php endif; ?> flex items-center justify-center transform hover:scale-110 transition-all duration-300 cursor-pointer backdrop-blur-sm" onclick="playRankSound()" data-tooltip="Top <?php echo e($currentRank); ?> Player - Click for details!">
                                                                    <!-- Rank number -->
                                                                    <span class="text-white font-bold text-lg drop-shadow-md"><?php echo e($currentRank); ?></span>
                                                                </div>
                                                                ...
                                                                <!-- Milestone indicator -->
                                                                <div class="mt-1 px-2 py-0.5 bg-gradient-to-r <?php if($currentRank == 1): ?> from-yellow-500/80 to-yellow-600/80 <?php elseif($currentRank == 2): ?> from-gray-500/80 to-gray-600/80 <?php else: ?> from-orange-500/80 to-orange-600/80 <?php endif; ?> text-white text-xs font-bold rounded-full shadow-md backdrop-blur-sm transform scale-90 border border-white/20">
                                                                    <?php if($currentRank == 1): ?>
                                                                        CHAMPION
                                                                    <?php elseif($currentRank == 2): ?>
                                                                        ELITE
                                                        ...
                                                        <div class="relative inline-flex items-center group">
                                                            <?php if($currentRank <= 10): ?>
                                                                ...
                                                                <div class="w-10 h-10 bg-gradient-to-br from-indigo-500/80 to-purple-600/80 rounded-full flex items-center justify-center shadow-md border-2 border-indigo-400/50 transform hover:scale-105 transition-all duration-200 cursor-pointer backdrop-blur-sm" onclick="playRankSound()" data-tooltip="Top 10 Player - Excellent performance!">
                                                                    <span class="text-white font-bold text-sm"><?php echo e($currentRank); ?></span>
                                                                </div>
                                                            ...
                                                            <?php else: ?>
                                                                <!-- Regular rank -->
                                                                <span class="text-gray-300 font-semibold text-lg hover:text-white transition-colors duration-200 cursor-pointer" onclick="playRankSound()" data-tooltip="Rank #<?php echo e($currentRank); ?>">#<?php echo e($currentRank); ?></span>
                                                            <?php endif; ?>
                                                        </div>
                                                    <?php endif; ?>
                                                </td>
                                                <td class="py-4 px-6">
                                                    <div class="flex items-center gap-3 group">
                                                        ...
                                                        <img src="<?php echo e(asset('storage/' . $player->profile_picture)); ?>"
                                                            alt="<?php echo e($player->name); ?>'s Profile Picture"
                                                            ...
                                                            data-tooltip="<?php echo e($player->name); ?>'s Profile Picture"
                                                            onerror="this.onerror=null; this.replaceWith(
                                                                Object.assign(document.createElement('div'), {
                                                                    ...
                                                                    onclick: playClickSound,
                                                                    dataset: { tooltip: '<?php echo e($player->name); ?>\'s Avatar' },
                                                        ...
                                                        <?php else: ?>
                                                            <div class="w-10 h-10 bg-gradient-to-r from-blue-500/80 to-indigo-600/80 rounded-full flex items-center justify-center text-white text-sm font-bold shadow-md transform hover:scale-110 transition-all duration-200 cursor-pointer backdrop-blur-sm border border-white/20" onclick="playClickSound()" data-tooltip="<?php echo e($player->name); ?>'s Avatar">
                                                                <span class="text-lg"><?php echo e(strtoupper(substr($player->name, 0, 1))); ?></span>
                                                            </div>
                                                        <?php endif; ?>
                                                        <div>
                                                            <div class="font-semibold text-white group-hover:text-blue-400 transition-colors duration-200 cursor-pointer" onclick="showPlayerDetails(<?php echo e($player->user_id); ?>, '<?php echo e($player->name); ?>')"><?php echo e($player->name); ?></div>
                                                            <?php if(auth()->id() == $player->user_id): ?>
                                                ...
                                                <td class="py-4 px-6 text-right font-bold text-white group-hover:text-blue-400 transition-colors duration-200">
                                                    <span class="cursor-pointer" onclick="playClickSound()" data-tooltip="<?php echo e(number_format($player->total_score)); ?> total points"><?php echo e(number_format($player->total_score)); ?></span>
                                                </td>
                                                <td class="py-4 px-6 text-right text-gray-300 group-hover:text-blue-400 transition-colors duration-200">
                                                    <span class="cursor-pointer" onclick="playClickSound()" data-tooltip="<?php echo e($player->games_played); ?> games played"><?php echo e($player->games_played); ?></span>
                                                </td>
                                                <td class="py-4 px-6 text-right text-gray-300 font-medium group-hover:text-blue-400 transition-colors duration-200">
                                                    <span class="cursor-pointer" onclick="playClickSound()" data-tooltip="<?php echo e(number_format($player->avg_accuracy, 1)); ?>% accuracy"><?php echo e(number_format($player->avg_accuracy, 1)); ?>%</span>
                                                </td>
                                            </tr>
                        ...
                        <div class="overflow-x-auto rounded-lg border border-white/10 shadow-sm">
                            <table class="w-full">
                                ...
                                <tbody id="quizLeaderboardBody">
                                    <?php if($quizLeaderboard->count() > 0): ?>
                                        <?php
                                            $currentScore = null;
                                            $currentRank = 0;
                                        ?>
                                        <?php $__currentLoopData = $quizLeaderboard; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $player): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php
                                                // Handle ties by checking if score is different from previous
                                            ...
                                            ?>
                                            <tr class="hover:bg-blue-500/10 transition-all duration-150 <?php if(auth()->id() == $player->user_id): ?> bg-blue-500/20 border-l-4 border-blue-400 <?php endif; ?> border-b border-white/10 player-row" data-player-id="<?php echo e($player->user_id); ?>" data-player-name="<?php echo e($player->name); ?>" data-player-score="<?php echo e($player->best_score); ?>" data-player-games="<?php echo e($player->games_played); ?>" data-player-accuracy="<?php echo e(number_format($player->avg_accuracy, 1)); ?>">
                                                <td class="py-4 px-6">
                                                    <?php if($currentRank <= 3): ?>
                                                        <!-- Enhanced Rank Badge -->
                                                        <div class="relative inline-flex items-center justify-center group">
                                                            <!-- Outer glow ring -->
                                                            <div class="absolute inset-0 rounded-full animate-pulse <?php if($currentRank == 1): ?> bg-blue-400/30 <?php elseif($currentRank == 2): ?> bg-indigo-400/30 <?php else: ?> bg-purple-400/30 <?php endif; ?> opacity-50 blur-md"></div>
                                                            
                                                            <!-- Main badge container -->
                                                            <div class="relative inline-flex flex-col items-center">
                                                                <!-- Badge background with gradient and border -->
                                                                <div class="w-14 h-14 rounded-full <?php if($currentRank == 1): ?> bg-gradient-to-br from-blue-400/80 via-blue-500/80 to-blue-600/80 <?php elseif($currentRank == 2): ?> bg-gradient-to-br from-indigo-400/80 via-indigo-500/80 to-indigo-600/80 <?php else: ?> bg-gradient-to-br from-purple-400/80 via-purple-500/80 to-purple-600/80 <?php endif; ?> shadow-lg border-2 <?php if($currentRank == 1): ?> border-blue-400/50 <?php elseif($currentRank == 2): ?> border-indigo-400/50 <?php else: ?> border-purple-400/50 <?php endif; ?> flex items-center justify-center transform hover:scale-110 transition-all duration-300 cursor-pointer backdrop-blur-sm" onclick="playRankSound()" data-tooltip="Top <?php echo e($currentRank); ?> Quiz Master - Click for details!">
                                                                    <!-- Rank number -->
                                                                    <span class="text-white font-bold text-lg drop-shadow-md"><?php echo e($currentRank); ?></span>
                                                                </div>
                                                                ...
                                                                <!-- Milestone indicator -->
                                                                <div class="mt-1 px-2 py-0.5 bg-gradient-to-r <?php if($currentRank == 1): ?> from-blue-500/80 to-blue-600/80 <?php elseif($currentRank == 2): ?> from-indigo-500/80 to-indigo-600/80 <?php else: ?> from-purple-500/80 to-purple-600/80 <?php endif; ?> text-white text-xs font-bold rounded-full shadow-md backdrop-blur-sm transform scale-90 border border-white/20">
                                                                    <?php if($currentRank == 1): ?>
                                                                        GENIUS
                                                                    <?php elseif($currentRank == 2): ?>
                                                                        EXPERT
                                                    ...
                                                    <?php else: ?>
                                                        ...
                                                        <div class="relative inline-flex items-center group">
                                                            ...
                                                            <?php else: ?>
                                                                <!-- Regular rank -->
                                                                <span class="text-gray-300 font-semibold text-lg hover:text-white transition-colors duration-200 cursor-pointer" onclick="playRankSound()" data-tooltip="Quiz Rank #<?php echo e($currentRank); ?>">#<?php echo e($currentRank); ?></span>
                                                            <?php endif; ?>
                                                        </div>
                                                    <?php endif; ?>
                                                </td>
                                                ...
                                                <td class="py-4 px-6 text-right font-bold text-white group-hover:text-blue-400 transition-colors duration-200">
                                                    <span class="cursor-pointer" onclick="playClickSound()" data-tooltip="<?php echo e(number_format($player->best_score)); ?> quiz points"><?php echo e(number_format($player->best_score)); ?></span>
                                                </td>
                                                <td class="py-4 px-6 text-right text-gray-300 group-hover:text-blue-400 transition-colors duration-200">
                                                    <span class="cursor-pointer" onclick="playClickSound()" data-tooltip="<?php echo e($player->games_played); ?> quiz games"><?php echo e($player->games_played); ?></span>
                                                </td>
                                                <td class="py-4 px-6 text-right text-gray-300 font-medium group-hover:text-blue-400 transition-colors duration-200">
                                                    <span class="cursor-pointer" onclick="playClickSound()" data-tooltip="<?php echo e(number_format($player->avg_accuracy, 1)); ?>% quiz accuracy"><?php echo e(number_format($player->avg_accuracy, 1)); ?>%</span>
                                                </td>
                                            </tr>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php else: ?>
                        ...
                        <div class="overflow-x-auto rounded-lg border border-white/10 shadow-sm">
                            <table class="w-full">
                                ...
                                <tbody id="wordScrambleLeaderboardBody">
                                    <?php if($wordScrambleLeaderboard->count() > 0): ?>
                                        <?php
                                            $currentScore = null;
                                            $currentRank = 0;
                                        ?>
                                        <?php $__currentLoopData = $wordScrambleLeaderboard; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $player): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php
                                                // Handle ties by checking if score is different from previous
                                                if ($player->best_score != $currentScore) {
                                                    $currentRank = $index + 1;
                                            ...
                                            ?>
                                            <tr class="hover:bg-green-500/10 transition-all duration-150 <?php if(auth()->id() == $player->user_id): ?> bg-green-500/20 border-l-4 border-green-400 <?php endif; ?> border-b border-white/10 player-row" data-player-id="<?php echo e($player->user_id); ?>" data-player-name="<?php echo e($player->name); ?>" data-player-score="<?php echo e($player->best_score); ?>" data-player-games="<?php echo e($player->games_played); ?>" data-player-accuracy="<?php echo e(number_format($player->avg_accuracy, 1)); ?>">
                                                <td class="py-4 px-6">
                                                    <?php if($currentRank <= 3): ?>
                                                        <!-- Enhanced Rank Badge -->
                                                        <div class="relative inline-flex items-center justify-center group">
                                                            <!-- Outer glow ring -->
                                                            <div class="absolute inset-0 rounded-full animate-pulse <?php if($currentRank == 1): ?> bg-green-400/30 <?php elseif($currentRank == 2): ?> bg-emerald-400/30 <?php else: ?> bg-teal-400/30 <?php endif; ?> opacity-50 blur-md"></div>
                                                            
                                                            <!-- Main badge container -->
                                                            <div class="relative inline-flex flex-col items-center">
                                                                <!-- Badge background with gradient and border -->
                                                                <div class="w-14 h-14 rounded-full <?php if($currentRank == 1): ?> bg-gradient-to-br from-green-400/80 via-green-500/80 to-green-600/80 <?php elseif($currentRank == 2): ?> bg-gradient-to-br from-emerald-400/80 via-emerald-500/80 to-emerald-600/80 <?php else: ?> bg-gradient-to-br from-teal-400/80 via-teal-500/80 to-teal-600/80 <?php endif; ?> shadow-lg border-2 <?php if($currentRank == 1): ?> border-green-400/50 <?php elseif($currentRank == 2): ?> border-emerald-400/50 <?php else: ?> border-teal-400/50 <?php endif; ?> flex items-center justify-center transform hover:scale-110 transition-all duration-300 cursor-pointer backdrop-blur-sm" onclick="playRankSound()" data-tooltip="Top <?php echo e($currentRank); ?> Word Master - Click for details!">
                                                                    <!-- Rank number -->
                                                                    <span class="text-white font-bold text-lg drop-shadow-md"><?php echo e($currentRank); ?></span>
                                                                </div>
                                                                ...
                                                                <!-- Milestone indicator -->
                                                                <div class="mt-1 px-2 py-0.5 bg-gradient-to-r <?php if($currentRank == 1): ?> from-green-500/80 to-green-600/80 <?php elseif($currentRank == 2): ?> from-emerald-500/80 to-emerald-600/80 <?php else: ?> from-teal-500/80 to-teal-600/80 <?php endif; ?> text-white text-xs font-bold rounded-full shadow-md backdrop-blur-sm transform scale-90 border border-white/20">
                                                                    <?php if($currentRank == 1): ?>
                                                                        SAGE
                                                                    <?php elseif($currentRank == 2): ?>
                                                                        WIZARD
                                                    ...
                                                    <?php else: ?>
                                                        ...
                                                        <div class="relative inline-flex items-center group">
                                                            ...
                                                            <?php else: ?>
                                                                <!-- Regular rank -->
                                                                <span class="text-gray-400 font-semibold text-lg hover:text-green-400 transition-colors duration-200 cursor-pointer" onclick="playRankSound()" data-tooltip="Word Scramble Rank #<?php echo e($currentRank); ?>">#<?php echo e($currentRank); ?></span>
                                                            <?php endif; ?>
                                                        </div>
                                                    <?php endif; ?>
                                                </td>
                                                <td class="py-4 px-6">
                                                    <div class="flex items-center gap-3 group">
                                                        ...
                                                        <?php else: ?>
                                                            <div class="w-10 h-10 bg-gradient-to-r from-green-500/80 to-emerald-600/80 rounded-full flex items-center justify-center text-white text-sm font-bold shadow-md transform hover:scale-110 transition-all duration-200 cursor-pointer backdrop-blur-sm border border-white/20" onclick="playClickSound()" data-tooltip="<?php echo e($player->name); ?>'s Avatar">
                                                                <span class="text-lg"><?php echo e(strtoupper(substr($player->name, 0, 1))); ?></span>
                                                            </div>
                                                        <?php endif; ?>
                                                        <div>
                                                            <div class="font-semibold text-white group-hover:text-green-400 transition-colors duration-200 cursor-pointer" onclick="showPlayerDetails(<?php echo e($player->user_id); ?>, '<?php echo e($player->name); ?>')"><?php echo e($player->name); ?></div>
                                                            <?php if(auth()->id() == $player->user_id): ?>
                                                ...
                                                <td class="py-4 px-6 text-right font-bold text-white group-hover:text-green-400 transition-colors duration-200">
                                                    <span class="cursor-pointer" onclick="playClickSound()" data-tooltip="<?php echo e(number_format($player->best_score)); ?> word scramble points"><?php echo e(number_format($player->best_score)); ?></span>
                                                </td>
                                                <td class="py-4 px-6 text-right text-gray-300 group-hover:text-green-400 transition-colors duration-200">
                                                    <span class="cursor-pointer" onclick="playClickSound()" data-tooltip="<?php echo e($player->games_played); ?> word scramble games"><?php echo e($player->games_played); ?></span>
                                                </td>
                                                <td class="py-4 px-6 text-right">
                                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-gradient-to-r from-green-500/80 to-emerald-600/80 text-white shadow-sm backdrop-blur-sm border border-white/20 cursor-pointer" onclick="playClickSound()" data-tooltip="<?php echo e(number_format($player->avg_accuracy, 1)); ?>% accuracy in word scramble">
                                                        <?php echo e(number_format($player->avg_accuracy, 1)); ?>%
                                                    </span>
                                                </td>
                                            </tr>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="mt-8 text-center">
            <a href="<?php echo e(route('profile')); ?>" class="inline-flex items-center gap-2 px-6 py-3 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-xl font-medium transition-colors duration-200">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Rayver\Desktop\pawikan-patrol\my_app\resources\views/leaderboards.blade.php ENDPATH**/ ?>