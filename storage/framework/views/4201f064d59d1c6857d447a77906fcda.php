                                        ...
                                        <td class="px-6 py-4 text-sm font-medium">
                                            <div class="flex items-center space-x-2">
                                                ...
                                                <?php if($report->status == 'submitted'): ?>
                                                    <a href="<?php echo e(route('patroller.reports.edit', $report)); ?>" class="text-yellow-400 hover:text-yellow-300 transition-colors">
...
<?php echo $__env->make('layouts.patroller', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Rayver\Desktop\pawikan-patrol\my_app\resources\views/patroller/reports/index.blade.php ENDPATH**/ ?>