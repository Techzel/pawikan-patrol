                    ...
                    <div class="resource-item group/item relative bg-white/5 hover:bg-blue-600/10 border border-white/10 rounded-xl p-3 transition-all duration-300 cursor-pointer" 
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div class="flex-1 min-w-0">
                                <h4 class="text-white text-[13px] font-bold truncate group-hover/item:text-blue-300 transition-colors tracking-tight"><?php echo e($file['title']); ?></h4>
                                <p class="text-[11px] text-gray-400 line-clamp-1 italic mt-0.5"><?php echo e($file['description']); ?></p>
                                <div class="flex items-center gap-2 mt-0.5">
                                    <span class="text-[9px] text-gray-500 font-medium font-poppins">PDF • <?php echo e(date('M d, Y', strtotime($file['published_date']))); ?></span>
                                    <!-- Hidden metadata for search -->
                                    <span class="hidden-search-data hidden"><?php echo e($file['description']); ?></span>
                                </div>
                            </div>
                            <!-- Actions -->
