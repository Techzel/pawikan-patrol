                            ...
                            <?php $__currentLoopData = $files; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="bg-gray-800/50 border border-gray-700 rounded-lg p-4 flex items-center justify-between group hover:border-blue-500/30 transition-colors">
                                    ...
                                    <div class="flex items-center gap-2">
                                        <button onclick="openPdfPreview('<?php echo e($file['url']); ?>', '<?php echo e(addslashes($file['title'])); ?>', '<?php echo e(addslashes($file['description'])); ?>', '<?php echo e(date('M d, Y', strtotime($file['published_date']))); ?>')" class="p-2 text-gray-400 hover:text-blue-400 bg-gray-700/50 hover:bg-gray-700 rounded-lg transition-colors" title="View Preview">
