                ...
                <div class="p-6">
                    <form action="<?php echo e(route('admin.content.storytelling.upload')); ?>" method="POST" enctype="multipart/form-data" class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="date" name="published_date" value="<?php echo e(date('Y-m-d')); ?>"
                            ...
                            <?php $__currentLoopData = $files; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="bg-gray-800/50 border border-gray-700 rounded-lg p-4 flex items-center justify-between group hover:border-blue-500/30 transition-colors">
                                    <div class="flex items-center gap-4 overflow-hidden">
                                        ...
                                        <div class="min-w-0">
                                            <h4 class="text-white font-medium truncate" title="<?php echo e($file['title']); ?>">
                                                <?php echo e($file['title']); ?>

                                            </h4>
                                            <p class="text-[10px] text-gray-500 truncate mb-1"><?php echo e($file['name']); ?></p>
                                            <div class="flex text-xs text-gray-500 gap-3">
                                                <span><?php echo e(number_format($file['size'] / 1024, 1)); ?> KB</span>
                                                <span>•</span>
                                                <span>Published: <?php echo e(date('M d, Y', strtotime($file['published_date']))); ?></span>
                                            </div>
                                            <p class="text-xs text-gray-400 mt-1 line-clamp-1 italic"><?php echo e($file['description']); ?></p>
                                        </div>
                                    </div>
                                    
                                    <div class="flex items-center gap-2">
                                        <button onclick="openPdfPreview('<?php echo e($file['url']); ?>', <?php echo e(json_encode($file['title'])); ?>, <?php echo e(json_encode($file['description'])); ?>, '<?php echo e(date('M d, Y', strtotime($file['published_date']))); ?>')" class="p-2 text-gray-400 hover:text-blue-400 bg-gray-700/50 hover:bg-gray-700 rounded-lg transition-colors" title="View Preview">
