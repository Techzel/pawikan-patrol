...
<?php $__env->startSection('content'); ?>
            ...
            <?php if(session('success')): ?>
                <div class="mb-6 bg-green-500/20 border border-green-500/40 text-green-100 px-4 py-3 rounded-lg flex items-center gap-3">
                    ...
                    <span class="" style="font-family: 'Poppins', sans-serif;"><?php echo e(session('success')); ?></span>
                </div>
            <?php endif; ?>
            ...
            <?php if(session('error')): ?>
                <div class="mb-6 bg-red-500/20 border border-red-500/40 text-red-100 px-4 py-3 rounded-lg flex items-center gap-3">
                    ...
                    <span class="" style="font-family: 'Poppins', sans-serif;"><?php echo e(session('error')); ?></span>
                </div>
            <?php endif; ?>
                        ...
                        <form action="<?php echo e(route('patroller.profile.update')); ?>" method="POST" enctype="multipart/form-data" class="space-y-5">
                            ...
                            <div class="text-center">
                                <div class="w-24 h-24 bg-gradient-to-br from-green-400 to-green-600 rounded-full mx-auto mb-4 flex items-center justify-center overflow-hidden">
                                    <?php if($patroller->profile_picture): ?>
                                        <img src="<?php echo e(Str::startsWith($patroller->profile_picture, 'data:') ? $patroller->profile_picture : asset('storage/'.$patroller->profile_picture)); ?>" alt="Profile" class="w-full h-full object-cover">
                                    <?php else: ?>
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <input type="text" name="name" value="<?php echo e(old('name', $patroller->name)); ?>" class="w-full mt-1 bg-white/5 border border-white/10 rounded-lg px-3 py-2 text-white focus:border-green-400 focus:ring-1 focus:ring-green-400">
                                </div>
                                <div>
                                    <label class="text-sm text-gray-300 " style="font-family: 'Poppins', sans-serif;">Email Address</label>
                                    <input type="email" name="email" value="<?php echo e(old('email', $patroller->email)); ?>" class="w-full mt-1 bg-white/5 border border-white/10 rounded-lg px-3 py-2 text-white focus:border-green-400 focus:ring-1 focus:ring-green-400">
                                </div>
                                <div>
                                    <label class="text-sm text-gray-300 " style="font-family: 'Poppins', sans-serif;">Phone Number</label>
                                    <input type="text" name="phone" value="<?php echo e(old('phone', $patroller->phone)); ?>" class="w-full mt-1 bg-white/5 border border-white/10 rounded-lg px-3 py-2 text-white focus:border-green-400 focus:ring-1 focus:ring-green-400">
                                </div>
                                <div>
                                    <label class="text-sm text-gray-300 " style="font-family: 'Poppins', sans-serif;">Username</label>
                                    <input type="text" name="username" value="<?php echo e(old('username', $patroller->username)); ?>" class="w-full mt-1 bg-white/5 border border-white/10 rounded-lg px-3 py-2 text-white focus:border-green-400 focus:ring-1 focus:ring-green-400">
                                </div>
                                <div>
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="glass-dark rounded-xl p-6 border border-green-500/20">
                        <div class="flex items-center justify-between mb-6">
                            ...
                            <a href="<?php echo e(route('patroller.reports.index')); ?>" class="text-green-400 hover:text-green-300 text-sm " style="font-family: 'Poppins', sans-serif;">
                                ...
                                <?php $__currentLoopData = $recentReports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $report): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="flex items-center justify-between p-4 bg-white/5 rounded-lg hover:bg-white/10 transition-colors">
                                        <div class="flex items-center space-x-4">
                                            ...
                                            <div>
                                                <p class="text-white font-medium " style="font-family: 'Poppins', sans-serif;"><?php echo e($report->title); ?></p>
                                                <p class="text-gray-400 text-sm " style="font-family: 'Poppins', sans-serif;"><?php echo e($report->created_at->diffForHumans()); ?></p>
                                            </div>
                                        </div>
                                        <div class="flex items-center space-x-3">
                                            ...
                                            <a href="<?php echo e(route('patroller.reports.show', $report)); ?>" class="text-green-400 hover:text-green-300">
                        ...
                        <?php else: ?>
                            <div class="text-center py-8">
                                ...
                                <a href="<?php echo e(route('patroller.reports.create')); ?>" class="text-green-400 hover:text-green-300 " style="font-family: 'Poppins', sans-serif;">
                    ...
                    <div class="glass-dark rounded-xl p-6 border border-green-500/20">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <a href="<?php echo e(route('patroller.reports.create')); ?>" class="bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white p-4 rounded-lg text-center transition-all duration-300 transform hover:scale-105 shadow-lg">
