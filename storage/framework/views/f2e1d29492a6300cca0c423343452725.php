...
<?php $__env->startSection('content'); ?>
            ...
            <div class="mb-8">
                <div class="flex items-center justify-between">
                    ...
                    <a href="<?php echo e(route('patroller.reports.create')); ?>" class="bg-gradient-to-r from-ocean-500 to-ocean-600 hover:from-ocean-600 hover:to-ocean-700 text-white px-6 py-3 rounded-lg font-medium transition-all duration-300 transform hover:scale-105 shadow-lg " style="font-family: 'Poppins', sans-serif;">
            ...
            <div class="glass-dark rounded-xl p-6 mb-8 border border-ocean-500/20">
                <form method="GET" action="<?php echo e(route('patroller.reports.index')); ?>" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                    ...
                    <div>
                        ...
                        <select name="status" class="w-full bg-gray-800 border border-ocean-500/30 rounded-lg px-3 py-2 text-white focus:ring-2 focus:ring-ocean-400 focus:border-transparent " style="font-family: 'Poppins', sans-serif;">
                    ...
                    <div>
                        ...
                        <select name="priority" class="w-full bg-gray-800 border border-ocean-500/30 rounded-lg px-3 py-2 text-white focus:ring-2 focus:ring-ocean-400 focus:border-transparent " style="font-family: 'Poppins', sans-serif;">
                    ...
                    <div>
                        ...
                        <select name="type" class="w-full bg-gray-800 border border-ocean-500/30 rounded-lg px-3 py-2 text-white focus:ring-2 focus:ring-ocean-400 focus:border-transparent " style="font-family: 'Poppins', sans-serif;">
                    ...
                    <div>
                        ...
                        <input type="date" name="date_from" value="<?php echo e(request('date_from')); ?>" class="w-full bg-gray-800 border border-ocean-500/30 rounded-lg px-3 py-2 text-white focus:ring-2 focus:ring-ocean-400 focus:border-transparent " style="font-family: 'Poppins', sans-serif;">
                    </div>

                    <!-- Filter Actions -->
                    <div class="flex items-end gap-2">
                        <button type="submit" class="bg-ocean-500 hover:bg-ocean-600 text-white px-4 py-2 rounded-lg transition-colors " style="font-family: 'Poppins', sans-serif;">
                            <i class="fas fa-filter mr-2"></i>Filter
                        </button>
                        <a href="<?php echo e(route('patroller.reports.index')); ?>" class="bg-gray-600 hover:bg-gray-700 text-white px-4 py-2 rounded-lg transition-colors " style="font-family: 'Poppins', sans-serif;">
                            ...
                            <tbody class="divide-y divide-ocean-500/20">
                                <?php $__currentLoopData = $reports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $report): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="hover:bg-white/5 transition-colors">
                                        <td class="px-6 py-4">
                                            <div>
                                                <div class="text-sm font-medium text-white " style="font-family: 'Poppins', sans-serif;"><?php echo e($report->title); ?></div>
                                                <div class="text-sm text-gray-400 " style="font-family: 'Poppins', sans-serif;"><?php echo e(Str::limit($report->description, 50)); ?></div>
                                                <div class="text-xs text-gray-500 " style="font-family: 'Poppins', sans-serif;"><?php echo e($report->location); ?></div>
                                            </div>
                                        </td>
                                        <td class="px-6 py-4">
                                        ...
                                        <td class="px-6 py-4 text-sm font-medium">
                                            <div class="flex items-center space-x-2">
                                                ...
                                                <?php if(in_array($report->status, ['submitted', 'rejected', 'needs_correction'])): ?>
                                                    ...
                                                    <form method="POST" action="<?php echo e(route('patroller.reports.destroy', $report)); ?>" class="inline" onsubmit="return showDeleteConfirmation(this)">
                                                        <?php echo csrf_field(); ?>
