...
<?php $__env->startSection('content'); ?>
            ...
            <div class="mb-8">
                <div class="flex items-center justify-between">
                    ...
                    <a href="<?php echo e(route('patroller.reports.create')); ?>" class="bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white px-6 py-3 rounded-lg font-medium transition-all duration-300 transform hover:scale-105 shadow-lg " style="font-family: 'Poppins', sans-serif;">
            ...
            <div class="glass-dark rounded-xl p-6 mb-8 border border-green-500/20">
                <form method="GET" action="<?php echo e(route('patroller.reports.index')); ?>" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                    ...
                    <div>
                        ...
                        <input type="date" name="date_from" value="<?php echo e(request('date_from')); ?>" class="w-full bg-gray-800 border border-green-500/30 rounded-lg px-3 py-2 text-white focus:ring-2 focus:ring-green-400 focus:border-transparent " style="font-family: 'Poppins', sans-serif;">
                    </div>
                                    ...
                                    <tr class="hover:bg-white/5 transition-colors">
                                        ...
                                        <td class="px-6 py-4 text-sm font-medium">
                                            <div class="flex items-center space-x-2">
                                                <a href="<?php echo e(route('patroller.reports.show', $report)); ?>" class="text-green-400 hover:text-green-300 transition-colors">
