        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-4">
                <div class="flex items-center space-x-4">
                    <a href="<?php echo e(route('admin.patrol-reports.index')); ?>" class="text-blue-400 hover:text-blue-300">
                        <i class="fas fa-arrow-left"></i>
                    </a>
                    <div>
                        <h1 class="text-xl font-bold text-white cinzel-heading">Patrol Report Details</h1>
                        <p class="text-sm text-gray-300">Review and manage report #<?php echo e($patrolReport->id); ?></p>
                    </div>
                </div>
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <span class="px-3 py-1 text-sm rounded-full cinzel-text
                        <?php if($patrolReport->status == 'pending_review'): ?> bg-blue-500/20 text-blue-300
                        <?php elseif($patrolReport->status == 'reviewing'): ?> bg-yellow-500/20 text-yellow-300
                        <?php elseif($patrolReport->status == 'accepted'): ?> bg-green-500/20 text-green-300
                        <?php elseif($patrolReport->status == 'reject'): ?> bg-red-500/20 text-red-300
                        <?php elseif($patrolReport->status == 'resolved'): ?> bg-purple-500/20 text-purple-300
                        <?php else: ?> bg-gray-500/20 text-gray-300 <?php endif; ?>">
                        <?php echo e(ucfirst(str_replace('_', ' ', $patrolReport->status))); ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        <?php $__currentLoopData = $patrolReport->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="bg-gray-700 rounded-lg overflow-hidden">
                                <img src="<?php echo e(asset('storage/' . $image)); ?>" alt="Report image" class="w-full h-48 object-cover hover:scale-105 transition-transform cursor-pointer" onclick="openImageModal('<?php echo e(asset('storage/' . $image)); ?>')">
                            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Rayver\Desktop\pawikan-patrol\my_app\resources\views/admin/patrol-reports/show.blade.php ENDPATH**/ ?>