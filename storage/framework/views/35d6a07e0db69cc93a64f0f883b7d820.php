...
<head>
    ...
    <title>Pawikan Patrol | <?php echo $__env->yieldContent('title', 'Sea Turtle Conservation'); ?></title>
    
    <!-- Favicon -->
    <link rel="icon" type="image/png" sizes="32x32" href="<?php echo e(asset('img/web_lg.png')); ?>">
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo e(asset('img/web_lg.png')); ?>">
...
<?php /**PATH C:\Users\Rayver\Desktop\pawikan-patrol\my_app\resources\views/layouts/app.blade.php ENDPATH**/ ?>