...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Patroller Dashboard'); ?> - Pawikan Patrol</title>
...
<body class="bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 min-h-screen font-['Cinzel']">
    ...
    <div class="pt-28 pb-12 px-4 sm:px-6 lg:px-8">
        <div class="<?php echo $__env->yieldContent('container-class', 'max-w-7xl'); ?> mx-auto">
...
<?php /**PATH C:\Users\Rayver\Desktop\pawikan-patrol\my_app\resources\views/layouts/patroller.blade.php ENDPATH**/ ?>