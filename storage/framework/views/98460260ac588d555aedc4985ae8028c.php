...
<?php
    ...
    $totalPatrollers = App\Models\User::where('role', 'patroller')->count();
?>
    ...
    <div class="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 pt-20">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 items-center gap-6">
                        ...
                        <div class="flex items-center justify-center lg:justify-start gap-3">
                            <div class="flex items-center gap-2">
                                ...
                                <span class="text-green-300 text-xs sm:text-sm font-medium">System Active</span>
                            </div>
                            <div class="flex items-center gap-2">
                                <div class="w-2 h-2 bg-blue-400 rounded-full animate-pulse delay-75"></div>
                                <span class="text-blue-300 text-xs sm:text-sm font-medium">Secure Connection</span>
                            </div>
                        </div>
                        ...
                        <div class="text-center">
                            <div class="flex flex-col items-center gap-2">
                                <div class="flex items-center gap-3">   
                                    <h1 class="text-xl sm:text-2xl font-bold text-blue-100 tracking-wider uppercase">Administrative Control Center</h1>
                                </div>
                                <p class="text-gray-300 text-sm sm:text-base font-medium">DENR Pawikan Patrol Management System</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center justify-center lg:justify-end gap-3">
                            <div class="flex items-center gap-2">
                                ...
                                <span class="text-blue-300 text-xs sm:text-sm font-medium">Authorized Access</span>
                            </div>
                            <div class="flex items-center gap-2">
                                <i class="fas fa-lock text-blue-400 text-sm"></i>
                                <span class="text-blue-300 text-xs sm:text-sm font-medium">Encrypted</span>
                            </div>
                        </div>
                    </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-6 sm:mb-8">
            <div class="bg-white/10 backdrop-blur-md rounded-xl p-4 sm:p-6 border border-white/20">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm font-medium text-gray-300">Total Patrollers</p>
            ...
            <div class="bg-white/10 backdrop-blur-md rounded-xl p-4 sm:p-6 border border-white/20">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm font-medium text-gray-300">Active Patrollers</p>
            ...
            <div class="bg-white/10 backdrop-blur-md rounded-xl p-4 sm:p-6 border border-white/20">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm font-medium text-gray-300">Accepted Reports</p>
            ...
            <div class="bg-white/10 backdrop-blur-md rounded-xl p-4 sm:p-6 border border-white/20">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm font-medium text-gray-300">User Verifications</p>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
                ...
                <div class="bg-white/10 backdrop-blur-md rounded-xl border border-white/20">
                    <div class="p-4 sm:p-6 border-b border-white/10">
                        <div class="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-4">
                            <h2 class="text-lg sm:text-xl font-bold text-white cinzel-subheading">Patroller Management</h2>
                            <button onclick="openCreatePatrollerModal()" class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 sm:py-2.5 rounded-lg font-medium transition-colors text-sm sm:text-base w-full sm:w-auto">
                            ...
                            <table class="w-full min-w-[600px]">
                                <thead>
                                    <tr class="text-center text-gray-300 border-b border-white/10">
                                        <th class="pb-3 font-medium text-sm sm:text-base">Name</th>
                                        <th class="pb-3 font-medium text-sm sm:text-base">Email</th>
                                        <th class="pb-3 font-medium text-sm sm:text-base">Status</th>
                                        <th class="pb-3 font-medium text-sm sm:text-base hidden sm:table-cell">Created By</th>
                                        <th class="pb-3 font-medium text-sm sm:text-base hidden sm:table-cell">Created</th>
                                        <th class="pb-3 font-medium text-sm sm:text-base">Actions</th>
                                    </tr>
                                </thead>
                                <tbody class="text-white">
                                    ...
                                    <tr class="border-b border-white/5 hover:bg-white/5">
                                        <td class="py-3 sm:py-4 text-center">
                                            <div class="font-medium"><?php echo e($patroller->name); ?></div>
                                            <div class="text-xs sm:text-sm text-gray-400 sm:hidden"><?php echo e($patroller->email); ?></div>
                                        </td>
            ...
            <div class="space-y-4 sm:space-y-6">
                ...
                <div class="bg-white/10 backdrop-blur-md rounded-xl border border-white/20">
                    <div class="p-4 sm:p-6">
                        <h3 class="text-base sm:text-lg font-bold text-white mb-3 sm:mb-4 cinzel-subheading">User Verification</h3>
                        <div class="space-y-2 sm:space-y-3">
                            <a href="<?php echo e(route('admin.verification.index')); ?>" class="flex items-center justify-between p-3 bg-blue-500/20 rounded-lg hover:bg-blue-500/30 transition-colors">
                                <div class="flex items-center space-x-2 sm:space-x-3">
                                    ...
                                    <span class="text-white text-sm sm:text-base">Verification Dashboard</span>
                                </div>
                ...
                <div class="bg-white/10 backdrop-blur-md rounded-xl border border-white/20">
                    <div class="p-4 sm:p-6">
                        <h3 class="text-base sm:text-lg font-bold text-white mb-3 sm:mb-4 cinzel-subheading">Patrol Reports</h3>
                        <div class="space-y-2 sm:space-y-3">
                            <a href="<?php echo e(route('admin.patrol-reports.index')); ?>" class="flex items-center justify-between p-3 bg-indigo-500/20 rounded-lg hover:bg-indigo-500/30 transition-colors">
                                <div class="flex items-center space-x-2 sm:space-x-3">
                                    ...
                                    <span class="text-white text-sm sm:text-base">Manage Reports</span>
                                </div>
        ...
        <div class="bg-white/10 backdrop-blur-md rounded-xl border border-white/20 w-full max-w-md sm:max-w-lg mx-auto mt-14 sm:mt-20">
            <div class="p-6 border-b border-white/10">
                <div class="flex justify-between items-center">
                    <h3 class="text-xl font-bold text-white cinzel-subheading">Create New Patroller</h3>
            ...
            <form id="createPatrollerForm" action="<?php echo e(route('admin.patrollers.store')); ?>" method="POST" class="p-6 space-y-6">
                <?php echo csrf_field(); ?>
                <div class="space-y-3">
                    <h4 class="text-sm font-semibold text-white uppercase tracking-wide">Basic Information</h4>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Rayver\Desktop\pawikan-patrol\my_app\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>