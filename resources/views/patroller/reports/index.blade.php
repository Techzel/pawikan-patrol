            ...
            <div class="glass-dark rounded-xl p-6 mb-8 border border-ocean-500/20">
                <form method="GET" action="{{ route('patroller.reports.index') }}" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                    ...
                    <div>
                        ...
                        <input type="date" name="date_from" value="{{ request('date_from') }}" class="w-full bg-gray-800 border border-ocean-500/30 rounded-lg px-3 py-2 text-white focus:ring-2 focus:ring-ocean-500 focus:border-transparent cinzel-text">
                    </div>
                    ...
                    <div class="flex items-end gap-2">
                        ...
                        <a href="{{ route('patroller.reports.index') }}" class="bg-gray-600 hover:bg-gray-700 text-white px-4 py-2 rounded-lg transition-colors cinzel-text">
                            ...
                            <tbody class="divide-y divide-ocean-500/20">
                                @foreach($reports as $report)
                                    <tr class="hover:bg-white/5 transition-colors">
                                        <td class="px-6 py-4">
                                            <div>
                                                <div class="text-sm font-medium text-white cinzel-text">{{ $report->title }}</div>
                                                <div class="text-sm text-gray-400 cinzel-text">{{ Str::limit($report->description, 50) }}</div>
                                                <div class="text-xs text-gray-500 cinzel-text">{{ $report->location }}</div>
                                            </div>
                                        </td>
                                        <td class="px-6 py-4">
