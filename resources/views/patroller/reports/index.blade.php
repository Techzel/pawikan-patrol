...
@section('content')
            ...
            <div class="mb-8">
                <div class="flex items-center justify-between">
                    ...
                    <a href="{{ route('patroller.reports.create') }}" class="bg-gradient-to-r from-ocean-500 to-ocean-600 hover:from-ocean-600 hover:to-ocean-700 text-white px-6 py-3 rounded-lg font-medium transition-all duration-300 transform hover:scale-105 shadow-lg " style="font-family: 'Poppins', sans-serif;">
            ...
            <div class="glass-dark rounded-xl p-6 mb-8 border border-ocean-500/20">
                <form method="GET" action="{{ route('patroller.reports.index') }}" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                    ...
                    <div>
                        ...
                        <input type="date" name="date_from" value="{{ request('date_from') }}" class="w-full bg-gray-800 border border-ocean-500/30 rounded-lg px-3 py-2 text-white focus:ring-2 focus:ring-ocean-400 focus:border-transparent " style="font-family: 'Poppins', sans-serif;">
                    </div>
