                    ...
                    <div class="glass-dark rounded-xl p-6 border border-ocean-500/20">
                        <form action="{{ route('patroller.profile.update') }}" method="POST" enctype="multipart/form-data" class="space-y-5">
                            ...
                            <div class="text-center">
                                ...
                                <label class="inline-flex items-center px-3 py-2 bg-ocean-500/20 text-ocean-400 rounded-lg cursor-pointer hover:bg-ocean-500/30 transition">
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="glass-dark rounded-xl p-6 border border-ocean-500/20">
                        <div class="flex items-center justify-between mb-6">
                            ...
                            <a href="{{ route('patroller.reports.index') }}" class="text-ocean-400 hover:text-ocean-300 text-sm " style="font-family: 'Poppins', sans-serif;">
                        ...
                        @else
                            <div class="text-center py-8">
                                ...
                                <a href="{{ route('patroller.reports.create') }}" class="text-ocean-400 hover:text-ocean-300 " style="font-family: 'Poppins', sans-serif;">
                    ...
                    <div class="glass-dark rounded-xl p-6 border border-ocean-500/20">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <a href="{{ route('patroller.dashboard') }}" class="bg-gradient-to-r from-ocean-500 to-ocean-600 hover:from-ocean-600 hover:to-ocean-700 text-white p-4 rounded-lg text-center transition-all duration-300 transform hover:scale-105 shadow-lg">
