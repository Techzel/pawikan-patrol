                ...
                <div class="glass-dark rounded-2xl p-8 border border-ocean-500/20 bg-gradient-to-r from-ocean-600/20 to-ocean-800/20">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-xl text-gray-300">Welcome back, <span class="text-ocean-400 font-semibold">{{ $patroller->name }}</span>!</p>
                            <p class="text-gray-400 mt-2">{{ now()->format('l, F j, Y') }} • {{ now()->format('g:i A') }}</p>
                        </div>
                        <div class="hidden md:block">
                            @if($patroller->profile_picture)
                                <img src="{{ Str::startsWith($patroller->profile_picture, 'data:') ? $patroller->profile_picture : asset('storage/' . $patroller->profile_picture) }}" class="w-24 h-24 rounded-full object-cover shadow-lg border-2 border-ocean-400">
                            @else
            ...
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-6 mb-8">
                ...
                <div class="lg:col-span-1 space-y-4">
                    <div class="glass-dark rounded-2xl p-6 border border-ocean-500/20">
                        ...
                        <div class="space-y-4">
                            <a href="{{ route('patroller.reports.create') }}" class="group block w-full bg-gradient-to-r from-ocean-500 to-ocean-600 hover:from-ocean-600 hover:to-ocean-700 text-white font-semibold py-4 px-6 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl text-center">
                ...
                <div class="lg:col-span-3">
                    <div class="glass-dark rounded-2xl p-6 border border-ocean-500/20 h-full">
                        <div class="flex items-center justify-between mb-6">
                            ...
                            <a href="{{ route('patroller.reports.index') }}" class="text-ocean-400 hover:text-ocean-300 text-sm transition-colors">
                        ...
                        <div class="space-y-3 max-h-80 overflow-y-auto custom-scrollbar">
                                ...
                                <div class="group flex items-center justify-between p-4 bg-white/5 hover:bg-white/10 rounded-xl transition-all duration-300 border border-transparent hover:border-ocean-500/30">
                                    <div class="flex items-center space-x-4 flex-1">
                                        <div class="w-12 h-12 rounded-xl flex items-center justify-center
                                            ...
                                            @else bg-gradient-to-br from-ocean-400 to-ocean-600 @endif shadow-lg">
                                            <svg class="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 20 20">
                                                <path fill-rule="evenodd" d="M4 4a2 2 0 012-2h4.586A2 2 0 0112 2.586L15.414 6A2 2 0 0116 7.414V16a2 2 0 01-2 2H6a2 2 0 01-2-2V4zm2 6a1 1 0 011-1h6a1 1 0 110 2H7a1 1 0 01-1-1zm1 3a1 1 0 100 2h6a1 1 0 100-2H7z" clip-rule="evenodd"/>
                                            </svg>
                                        </div>
                                        <div class="flex-1 min-w-0">
                                            <h4 class="text-white font-semibold truncate group-hover:text-ocean-400 transition-colors">{{ $report->title }}</h4>
                            ...
                            @empty
                                <div class="text-center py-12">
                                    ...
                                    <a href="{{ route('patroller.reports.create') }}" class="bg-gradient-to-r from-ocean-500 to-ocean-600 hover:from-ocean-600 hover:to-ocean-700 text-white px-6 py-3 rounded-lg font-medium transition-all duration-300 transform hover:scale-105 shadow-lg">
