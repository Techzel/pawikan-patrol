                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="hidden md:block">
                            @if($patroller->profile_picture)
                                <img src="{{ Str::startsWith($patroller->profile_picture, 'data:') ? $patroller->profile_picture : asset('storage/' . $patroller->profile_picture) }}" class="w-24 h-24 rounded-full object-cover shadow-lg border-2 border-green-400">
                            @else
