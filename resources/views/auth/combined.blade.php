                            ...
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="mb-6">
                                    ...
                                    <input type="text" id="loginUsername" name="username" required
                                        class="w-full px-4 py-3 bg-deep-800/50 border border-ocean-500/30 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-ocean-500 focus:border-transparent transition-all duration-300 {{ $errors->has('username') ? 'border-red-500/50' : '' }}"
                                ...
                                <div class="mb-6">
                                    ...
                                    <div class="input-group">
                                        <input type="password" id="loginPassword" name="password" required
                                            class="w-full px-4 py-3 bg-deep-800/50 border border-ocean-500/30 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-ocean-500 focus:border-transparent transition-all duration-300 pr-12 {{ $errors->has('password') ? 'border-red-500/50' : '' }}"
                            ...
                            <form method="POST" action="{{ route('register') }}">
                                ...
                                <div class="mb-5">
                                    ...
                                    <input type="text" id="registerName" name="name" required value="{{ old('name') }}"
                                        class="w-full px-4 py-3 bg-deep-800/50 border border-ocean-500/30 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-ocean-500 focus:border-transparent transition-all duration-300 {{ $errors->has('name') ? 'border-red-500/50' : '' }}"
                                ...
                                <div class="mb-5">
                                    ...
                                    <input type="email" id="registerEmail" name="email" required value="{{ old('email') }}"
                                        class="w-full px-4 py-3 bg-deep-800/50 border border-ocean-500/30 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-ocean-500 focus:border-transparent transition-all duration-300 {{ $errors->has('email') ? 'border-red-500/50' : '' }}"
