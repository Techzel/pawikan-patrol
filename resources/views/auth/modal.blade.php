                            ...
                            <div class="mb-6">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" id="loginUsername" name="username" required
                                        class="w-full pl-10 pr-4 py-3 simple-input rounded-lg text-white placeholder-gray-500 focus:outline-none font-poppins {{ $errors->has('username') ? 'border-red-500/50' : '' }}"
                            ...
                            <div class="mb-6">
                                ...
                                <div class="input-group relative">
                                    ...
                                    <input type="password" id="loginPassword" name="password" required
                                        class="w-full pl-10 pr-12 py-3 simple-input rounded-lg text-white placeholder-gray-500 focus:outline-none font-poppins {{ $errors->has('password') ? 'border-red-500/50' : '' }}"
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="text" id="registerName" name="name" required value="{{ old('name') }}"
                                            class="w-full pl-10 pr-4 py-3 simple-input rounded-lg text-white placeholder-gray-500 focus:outline-none font-poppins {{ $errors->has('name') ? 'border-red-500/50' : '' }}"
                            ...
                            <div class="mb-4">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="email" id="registerEmail" name="email" required value="{{ old('email') }}"
                                        class="w-full pl-10 pr-4 py-3 simple-input rounded-lg text-white placeholder-gray-500 focus:outline-none font-poppins {{ $errors->has('email') ? 'border-red-500/50' : '' }}"
                                ...
                                <div>
                                    ...
                                    <div class="input-group relative">
                                        ...
                                        <input type="password" id="registerPassword" name="password" required
                                            class="w-full pl-10 pr-10 py-3 simple-input rounded-lg text-white placeholder-gray-500 focus:outline-none font-poppins {{ $errors->has('password') ? 'border-red-500/50' : '' }}"
...
<div id="authTrigger" class="hidden" 
     data-has-error="{{ ($errors->any() || session('error')) ? 'true' : 'false' }}"
     data-has-success="{{ session('registration_success') ? 'true' : 'false' }}"
     data-form-type="{{ old('_form_type', 'login') }}">
</div>
