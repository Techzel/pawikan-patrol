            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="glass-dark rounded-2xl p-6 transform hover:scale-105 transition-all duration-300 border-l-4 border-yellow-500">
                    <div class="text-center mb-6">
                        <div class="relative inline-block group">
                            <div class="species-image-container relative w-36 h-36 mx-auto mb-4">
                                <img src="{{ asset('img/hawksbill-sea-turtle.png') }}" alt="Hawksbill Sea Turtle" class="species-image w-36 h-36 rounded-full object-cover border-4 border-yellow-500/30 absolute top-0 left-0 transition-opacity duration-300 ease-in-out group-hover:opacity-0">
                                <img src="{{ asset('img/baby-hawksbillturtle.png') }}" alt="Baby Hawksbill Sea Turtle" class="species-image-hover w-36 h-36 rounded-full object-cover border-4 border-yellow-500/30 absolute top-0 left-0 transition-opacity duration-300 ease-in-out opacity-0 group-hover:opacity-100">
                            </div>
                ...
                <div class="glass-dark rounded-2xl p-6 transform hover:scale-105 transition-all duration-300 border-l-4 border-blue-500">
                    <div class="text-center mb-6">
                        <div class="relative inline-block group">
                            <div class="species-image-container relative w-36 h-36 mx-auto mb-4">
                                <img src="{{ asset('img/olive-sea-turtle.png') }}" alt="Olive Ridley Sea Turtle" class="species-image w-36 h-36 rounded-full object-cover border-4 border-blue-500/30 absolute top-0 left-0 transition-opacity duration-300 ease-in-out group-hover:opacity-0">
                                <img src="{{ asset('img/baby-olive-turtle.png') }}" alt="Baby Olive Ridley Sea Turtle" class="species-image-hover w-36 h-36 rounded-full object-cover border-4 border-blue-500/30 absolute top-0 left-0 transition-opacity duration-300 ease-in-out opacity-0 group-hover:opacity-100">
                            </div>
