                    ...
                    <div class="bg-gradient-to-r from-blue-900/40 to-green-900/40 rounded-2xl p-8 max-w-4xl mx-auto border border-blue-500/30 shadow-lg relative overflow-hidden group hover:border-blue-500/50 transition-all duration-300">
                        ...
                        <div class="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
                            <div class="text-left w-full md:w-2/3">
                                <h3 class="text-2xl font-bold text-white mb-2">{{ $files[0]['name'] }}</h3>
                            ...
                            <div class="w-full md:w-1/3 flex justify-center md:justify-end">
                                <a href="{{ $files[0]['url'] }}" download class="flex items-center gap-3 px-8 py-4 bg-blue-600 hover:bg-blue-500 text-white rounded-xl font-bold transition-all shadow-lg hover:shadow-blue-500/50 hover:-translate-y-1 group-hover:scale-105 w-full md:w-auto justify-center md:justify-start">
                                    <span class="text-2xl">📥</span>
                                    <div class="text-left">
                                ...
                                <div class="bg-gray-900/60 rounded-xl p-4 border border-blue-500/20 hover:border-blue-500/40 transition-all duration-300 flex items-center justify-between gap-4">
                                    <div class="flex items-center gap-4 overflow-hidden">
                                        ...
                                        <div class="text-left min-w-0">
                                            <h4 class="font-bold text-white text-sm md:text-base truncate">{{ $file['name'] }}</h4>
                                            <p class="text-xs text-blue-200">PDF Document</p>
                                        </div>
                                    </div>
                                    
                                    <a href="{{ $file['url'] }}" download class="flex-shrink-0 flex items-center gap-2 px-4 py-2 bg-blue-600 hover:bg-blue-500 text-white rounded-lg text-sm font-bold transition-colors shadow-lg">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                    ...
                    <div class="text-center mb-6">
                        <div class="relative inline-block group">
                            <div class="species-image-container relative w-36 h-36 mx-auto mb-4">
                                <img src="{{ asset('img/green-sea-turtle.png') }}" alt="Green Sea Turtle" class="species-image w-36 h-36 rounded-full object-cover border-4 border-green-500/30 absolute top-0 left-0 transition-opacity duration-300 ease-in-out group-hover:opacity-0">
                                <img src="{{ asset('img/baby-green-turtle.png') }}" alt="Baby Green Sea Turtle" class="species-image-hover w-36 h-36 rounded-full object-cover border-4 border-green-500/30 absolute top-0 left-0 transition-opacity duration-300 ease-in-out opacity-0 group-hover:opacity-100">
                            </div>
                ...
                <div class="bg-gray-800 rounded-2xl p-6 transform hover:scale-105 transition-all duration-300 border border-green-500/30 shadow-lg">
                    <div class="text-center mb-6">
                        <div class="relative inline-block group">
                            <div class="species-image-container relative w-36 h-36 mx-auto mb-4">
                                <img src="{{ asset('img/hawksbill-sea-turtle.png') }}" alt="Hawksbill Sea Turtle" class="species-image w-36 h-36 rounded-full object-cover border-4 border-green-500/30 absolute top-0 left-0 transition-opacity duration-300 ease-in-out group-hover:opacity-0">
                                <img src="{{ asset('img/baby-hawksbillturtle.png') }}" alt="Baby Hawksbill Sea Turtle" class="species-image-hover w-36 h-36 rounded-full object-cover border-4 border-green-500/30 absolute top-0 left-0 transition-opacity duration-300 ease-in-out opacity-0 group-hover:opacity-100">
                            </div>
                ...
                <div class="bg-gray-800 rounded-2xl p-6 transform hover:scale-105 transition-all duration-300 border border-green-500/30 shadow-lg">
                    <div class="text-center mb-6">
                        <div class="relative inline-block group">
                            <div class="species-image-container relative w-36 h-36 mx-auto mb-4">
                                <img src="{{ asset('img/olive-sea-turtle.png') }}" alt="Olive Ridley Sea Turtle" class="species-image w-36 h-36 rounded-full object-cover border-4 border-green-500/30 absolute top-0 left-0 transition-opacity duration-300 ease-in-out group-hover:opacity-0">
                                <img src="{{ asset('img/baby-olive-turtle.png') }}" alt="Baby Olive Ridley Sea Turtle" class="species-image-hover w-36 h-36 rounded-full object-cover border-4 border-green-500/30 absolute top-0 left-0 transition-opacity duration-300 ease-in-out opacity-0 group-hover:opacity-100">
                            </div>
