...
@section('title', 'Pawikan Quiz - The Voyager Journey')
...
<div class="journey-container">
    ...
    @auth
        @if(isset($lastQuiz) && $lastQuiz->metadata)
        ...
        <div id="result-view" class="result-screen" style="display: none;">
            <div class="quiz-card-elegant">
                ...
                <div class="flex flex-col gap-3 items-center">
                    ...
                    <a href="{{ route('games.index') }}" class="text-gray-500 hover:text-white transition mt-2">Exit Quiz</a>
                </div>
            </div>
        </div>
    ...
    <!-- AUDIO -->
    <audio id="click-sfx" src="{{ asset('audio/click sa puzzle ug matching.mp3') }}" preload="auto"></audio>
    <audio id="success-sfx" src="{{ asset('audio/correct.mp3') }}" preload="auto"></audio>
    <audio id="error-sfx" src="{{ asset('audio/wrong.mp3') }}" preload="auto"></audio>
    <audio id="saved-sfx" src="{{ asset('audio/game-saved.mp3') }}" preload="auto"></audio>
</div>
@endsection
...
<script>
    ...
    function showHistory() {
        const data = @json($lastQuiz ? $lastQuiz->metadata : null);
