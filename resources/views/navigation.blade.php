        ...
        <div class="flex items-center justify-between h-20">
            ...
            <div class="hidden md:flex items-center space-x-4 lg:space-x-6">
                ...
                <div class="relative group">
                    <a href="{{ url('/') }}" onclick="if(window.location.pathname === '/' || window.location.pathname === '') { event.preventDefault(); window.scrollTo({top: 0, behavior: 'smooth'}); return false; }" class="flex items-center gap-1.5 text-white hover:text-ocean-300 transition-colors px-3 py-2 rounded-lg hover:bg-ocean-600/20 {{ request()->is('/') ? 'bg-ocean-600/30' : '' }}">
        ...
        <div class="px-2 pt-2 pb-3 space-y-1">
            ...
            <div class="space-y-1">
                ...
                <div class="ml-8 space-y-1">
                    ...
                    <a href="{{ url('/#dos-donts') }}" data-scroll-target="dos-donts" class="mobile-nav-link flex items-center gap-3 text-gray-300 hover:text-white hover:bg-ocean-600/20 px-3 py-2 rounded-lg transition-colors w-full text-left">
                        <span class="text-lg">✓✗</span>
                        <span class="text-sm font-semibold uppercase">DOs & DON'Ts</span>
                    </a>
