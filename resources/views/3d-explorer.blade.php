...
@section('bodyClass', '3d-explorer-page')
        ...
        <div class="model-card">
            ...
            <div class="sketchfab-wrapper" style="position: relative;">
                ...
                <iframe id="green-turtle-iframe" title="Green Sea Turtle" frameborder="0" allowfullscreen mozallowfullscreen="true" webkitallowfullscreen="true"
                        ...
                        src="https://sketchfab.com/models/422f77a6fba64e7e8969984e552f111a/embed?autostart=1&preload=1&ui_controls=1&ui_infos=0&ui_inspector=0&ui_stop=0&ui_watermark=0&origin={{ request()->getSchemeAndHttpHost() }}">
                </iframe>
            </div>
        ...
        <div class="model-card">
            ...
            <div class="sketchfab-wrapper" style="position: relative;">
                ...
                <iframe id="hawksbill-turtle-iframe" title="Hawksbill Turtle" frameborder="0" allowfullscreen mozallowfullscreen="true" webkitallowfullscreen="true"
                        allow="autoplay; fullscreen; xr-spatial-tracking" xr-spatial-tracking execution-while-out-of-viewport
                        execution-while-not-rendered web-share
                        src="https://sketchfab.com/models/0c0316cbed524374ab219f6d94b105c9/embed?autostart=1&preload=1&ui_controls=1&ui_infos=0&ui_inspector=0&ui_stop=0&ui_watermark=0&origin={{ request()->getSchemeAndHttpHost() }}">
                </iframe>
            </div>
        ...
        <div class="model-card">
            ...
            <div class="sketchfab-embed-wrapper sketchfab-wrapper" style="position: relative;">
                ...
                <iframe id="olive-ridley-iframe" title="Olive Ridley" frameborder="0" allowfullscreen mozallowfullscreen="true" webkitallowfullscreen="true" 
                        allow="autoplay; fullscreen; xr-spatial-tracking" xr-spatial-tracking execution-while-out-of-viewport 
                        execution-while-not-rendered web-share 
                        src="https://sketchfab.com/models/acbe292c128246ed8e532bfd9e646a03/embed?autostart=1&preload=1&ui_controls=1&ui_infos=0&ui_inspector=0&ui_stop=0&ui_watermark=0&origin={{ request()->getSchemeAndHttpHost() }}">
                </iframe>
            </div>
