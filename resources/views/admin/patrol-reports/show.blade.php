...
<div id="patrolReportShow" class="min-h-screen bg-gray-900">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="space-y-6">
                    ...
                    <div class="glass-dark rounded-xl p-6 border border-ocean-500/20">
                        ...
                        <div class="space-y-3">
                            <div>
                                ...
                                <div class="text-white font-medium cinzel-text">{{ $patrolReport->reviewer ? $patrolReport->reviewer->name : ( $patrolReport->verifier ? $patrolReport->verifier->name : 'N/A' ) }}</div>
                            </div>
                            <div>
                ...
                <div class="glass-dark rounded-xl p-6 border border-ocean-500/20">
                    ...
                    <div class="space-y-3">
                        @if($patrolReport->status == 'pending' || $patrolReport->status == 'submitted' || $patrolReport->status == 'under_review' || $patrolReport->status == 'pending_review' || $patrolReport->status == 'reviewing')
                        ...
                        @else
                            <div class="p-4 rounded-lg @if($patrolReport->status == 'accepted' || $patrolReport->status == 'validated' || $patrolReport->status == 'verified') bg-emerald-500/10 border border-emerald-500/30 @else bg-red-500/10 border border-red-500/30 @endif">
                                <div class="flex items-center space-x-3">
                                    <i class="fas @if($patrolReport->status == 'accepted' || $patrolReport->status == 'validated' || $patrolReport->status == 'verified') fa-check-circle text-emerald-400 @else fa-times-circle text-red-400 @endif"></i>
                                    <div>
                                        <h4 class="@if($patrolReport->status == 'accepted' || $patrolReport->status == 'validated' || $patrolReport->status == 'verified') text-emerald-300 @else text-red-300 @endif font-medium cinzel-text">
                                            Report {{ ucfirst(str_replace('_', ' ', $patrolReport->status)) }}
                                        </h4>
                                        <p class="@if($patrolReport->status == 'accepted' || $patrolReport->status == 'validated' || $patrolReport->status == 'verified') text-emerald-200/70 @else text-red-200/70 @endif text-xs cinzel-text mt-1">
    ...
    <!-- Delete Form -->
    <form id="deleteForm" action="{{ route('admin.patrol-reports.destroy', $patrolReport) }}" method="POST" style="display: none;">
        @csrf
        @method('DELETE')
    </form>
